...
export const Index: React.FC = () => {
    ...
    return (<div className={styles.main + " d-flex flex-column align-items-center justify-content-between"}>
        ...
        <img src={!isDark ? bg_light : bg_dark} className={styles.bg_img} height="20%" width="100%" />
        ...
        <div className={styles.subcontent + " d-flex flex-column align-items-center justify-content-center"}>
